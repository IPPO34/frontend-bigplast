  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (selectedFile) {
        ...
        if (imageData.url) {
          finalImageUrl = `${import.meta.env.VITE_API_URL || "http://127.0.0.1:5000"}${imageData.url}`;
        } else {
      ...
      <div className="max-w-6xl mx-auto px-6 pt-28 pb-12">
        ...
        <div className="flex justify-center gap-4 mb-8">
          <button
            ...
            className={`px-6 py-2 rounded-lg ${activeTab === "gestion" ? "bg-blue-600" : "bg-gray-700"} hover:bg-blue-700`}
          >
            Gestión
          </button>
          <button
            onClick={() => setActiveTab("productos")}
            className={`px-6 py-2 rounded-lg ${activeTab === "productos" ? "bg-blue-600" : "bg-gray-700"} hover:bg-blue-700`}
          >
            Productos
          </button>
        </div>
